 ...
 * @param explicitIntents list here the view intents outside of the module or the ones inside the module that should be handled
...
annotation class Reducer(
    val explicitIntents: Array<KClass<*>> = [],
